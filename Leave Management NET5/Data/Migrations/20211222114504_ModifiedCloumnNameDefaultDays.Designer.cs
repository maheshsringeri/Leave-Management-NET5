...
namespace Leave_Management_NET5.Data.Migrations
{
    ...
    [Migration("20211222114504_ModifiedCloumnNameDefaultDays")]
    partial class ModifiedCloumnNameDefaultDays
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Leave_Management_NET5.Data.LeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_NET5.Data.LeaveHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_NET5.Data.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_NET5.Models.LeaveTypeVM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_NET5.Data.Employee", b =>
                {
            ...
            modelBuilder.Entity("Leave_Management_NET5.Data.LeaveAllocation", b =>
                {
                    b.HasOne("Leave_Management_NET5.Data.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Leave_Management_NET5.Data.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("Leave_Management_NET5.Data.LeaveHistory", b =>
                {
                    b.HasOne("Leave_Management_NET5.Data.Employee", "ApprovedBy")
                        .WithMany()
                    ...
                    b.HasOne("Leave_Management_NET5.Data.Employee", "RequestingEmployee")
                        .WithMany()
